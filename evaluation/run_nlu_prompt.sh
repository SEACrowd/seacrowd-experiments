...
# # Llama 3
# CUDA_VISIBLE_DEVICES=2 python main_nlu_prompt_batch.py eng meta-llama/Meta-Llama-3-8B-Instruct 4 &

# # English - Falcon
# CUDA_VISIBLE_DEVICES=5 python main_nlu_prompt_batch.py eng tiiuae/falcon-7b-instruct 4 &
...
# AYA
CUDA_VISIBLE_DEVICES=3 python main_nlu_prompt_batch.py eng CohereForAI/aya-101 4 &