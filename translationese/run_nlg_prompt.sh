...
# # AYA-23 --> Holy
# CUDA_VISIBLE_DEVICES=7 python main_nlg_prompt_batch.py CohereForAI/aya-23-8B 4 &

# Multilingual - BLOOMZ --> Ruochen
CUDA_VISIBLE_DEVICES=0 python main_nlg_prompt_batch.py bigscience/bloomz-7b1 4 &

# Multilingual - Bactrian-X --> Ruochen
CUDA_VISIBLE_DEVICES=1 python main_nlg_prompt_batch.py MBZUAI/bactrian-x-llama-7b-merged 4 &

# Multilingual - Mistral --> Joseph
CUDA_VISIBLE_DEVICES=2 python main_nlg_prompt_batch.py mistralai/Mistral-7B-Instruct-v0.2 4 &

# Llama 3 --> Joseph
CUDA_VISIBLE_DEVICES=6 python main_nlg_prompt_batch.py meta-llama/Meta-Llama-3-8B-Instruct 4 &

# English - Falcon --> Ruochen
CUDA_VISIBLE_DEVICES=7 python main_nlg_prompt_batch.py tiiuae/falcon-7b-instruct 4 &
...
# # SEA - SAILOR --> Holy
# CUDA_VISIBLE_DEVICES=1 python main_nlg_prompt_batch.py sail/Sailor-7B-Chat 4 &
...
# CUDA_VISIBLE_DEVICES=6 python main_nlg_prompt_batch.py Ichsan2895/Merak-7B-v4 4 &
